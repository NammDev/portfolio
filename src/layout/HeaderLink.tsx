  ...
  return (
    <header className='mb-10 ml-auto hidden h-[144px]  rounded-[16px] bg-white p-[30px]  dark:bg-[#111111] lg:block lg:w-[526px] '>
      <nav className='hidden lg:block'>
        <ul className='flex    '>
          <Link
            className='   font-poppins text-xtiny text-gray-lite  linked  mx-2.5 flex h-20    w-full  cursor-pointer  flex-col items-center  justify-center rounded-[10px] bg-[#F3F6F6]    bg-gradient-to-r from-[#FA5252] to-[#DD2476] font-medium   text-white  transition-all duration-300 ease-in-out dark:text-[#A6A6A6]'
            to='/about'
          >
