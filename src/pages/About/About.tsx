            ...
            <div className='hidden grid-cols-12 items-center pt-4 md:gap-10 md:pt-[30px] lg:grid '>
              <div className='col-span-12 space-y-2.5'>
                <div className='lg:mr-16'>
                  ...
                  <p className='text-gray-lite dark:text-color-910 mt-2.5 leading-7'>
            ...
            <div className='grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-2 '>
              <div className='about-box dark:bg-transparent' style={{ background: 'rgb(252, 244, 255)' }}>
                <img
                  ...
                  src='/static/media/icon-1.71b741a6ab73765534e80db0a934febd.svg'
                  alt=''
                />
              ...
              <div className='about-box dark:bg-transparent' style={{ background: 'rgb(254, 250, 240)' }}>
                <img
                  className='block h-10 w-10  object-contain'
                  src='/static/media/icon-2.cbff424c7b23532c3f955e6f747ee1fa.svg'
                  alt=''
                />
                <div className='space-y-2 break-all'>
              ...
              <div className='about-box dark:bg-transparent' style={{ background: 'rgb(252, 244, 255)' }}>
                <img
                  className='block h-10 w-10  object-contain'
                  src='/static/media/icon-3.c226edafbaa53ebea0decda25185b879.svg'
                  alt=''
                />
                <div className='space-y-2 break-all'>
              ...
              <div className='about-box dark:bg-transparent' style={{ background: 'rgb(255, 244, 244)' }}>
                <img
                  className='block h-10 w-10  object-contain'
                  src='/static/media/icon-4.6989ae67f415633aa2e1e3fd2e3c15a1.svg'
                  alt=''
                />
                <div className='space-y-2 break-all'>
                  <h3 className='text-xl font-semibold dark:text-white'>Photography</h3>
              ...
              <div className='about-box dark:bg-transparent' style={{ background: 'rgb(255, 240, 248)' }}>
                <img
                  className='block h-10 w-10  object-contain'
                  src='/static/media/icon-5.b7ce008f06241f1d51b48260af8b73f4.svg'
                  alt=''
                />
                <div className='space-y-2 break-all'>
              ...
              <div className='about-box dark:bg-transparent' style={{ background: 'rgb(243, 250, 255)' }}>
                <img
                  className='block h-10 w-10  object-contain'
                  src='/static/media/icon-6.7a458dd3dce6df96d462489320d4a456.svg'
                  alt=''
                />
                <div className='space-y-2 break-all'>
