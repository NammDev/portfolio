  ...
  return (
    <section className='bg-white  dark:bg-[#111111] lg:rounded-2xl'>
      <div data-aos='fade' className='aos-init aos-animate'>
        ...
        <div className='bg-color-810 container px-2 py-12 dark:bg-[#0D0D0D] sm:px-5 md:px-10 lg:px-20'>
          <div className='grid grid-cols-1  gap-8 md:grid-cols-2'>
            <div className='col-span-1'>
              <h4 className='mb-6 text-5xl font-medium dark:text-white'>Working Skills</h4>
              <div className=' mb-7'>
                <div className='flex justify-between py-1'>
                  <span className=' text-gray-lite text-base font-semibold dark:text-[#A6A6A6]'>Web Design</span>
                  <span className=' text-gray-lite pr-5 text-base font-semibold dark:text-[#A6A6A6]'>80%</span>
                </div>
   ...
   L 99.5,0.5'
              ...
              <div className=' mb-7'>
                <div className='flex justify-between py-1'>
                  <span className=' text-gray-lite text-base font-semibold dark:text-[#A6A6A6]'>Mobile App </span>
                  <span className=' text-gray-lite pr-5 text-base font-semibold dark:text-[#A6A6A6]'>95%</span>
                </div>
                <svg className='rc-progress-line' viewBox='0 0 100 1' preserveAspectRatio='none'>
                  <path
                    className='rc-progress-line-trail'
   ...
   L 99.5,0.5'
              ...
              <div className=' mb-7'>
                <div className='flex justify-between py-1'>
                  <span className=' text-gray-lite text-base font-semibold dark:text-[#A6A6A6]'>Illustrator</span>
                  <span className=' text-gray-lite pr-5 text-base font-semibold dark:text-[#A6A6A6]'>65%</span>
                </div>
                <svg className='rc-progress-line' viewBox='0 0 100 1' preserveAspectRatio='none'>
                  <path
                    className='rc-progress-line-trail'
   ...
   L 99.5,0.5'
              ...
              <div className=' mb-7'>
                <div className='flex justify-between py-1'>
                  <span className=' text-gray-lite text-base font-semibold dark:text-[#A6A6A6]'>Photoshope</span>
                  <span className=' text-gray-lite pr-5 text-base font-semibold dark:text-[#A6A6A6]'>75%</span>
                </div>
                <svg className='rc-progress-line' viewBox='0 0 100 1' preserveAspectRatio='none'>
                  <path
                    className='rc-progress-line-trail'
   ...
   L 99.5,0.5'
            ...
            <div className='col-span-1'>
              <h4 className='mb-8 text-5xl font-medium dark:text-white'>Knowledges</h4>
        ...
        <footer className='overflow-hidden rounded-b-2xl' style={{ background: 'rgb(255, 255, 255)' }}>
